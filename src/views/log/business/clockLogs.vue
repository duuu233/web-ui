    ...
    <div class="table-container">
      ...
      >
        <el-table-column type="index" align="center"> </el-table-column>
            <el-table-column label="配送员ID" align="center">
          <template slot-scope="scope">{{ scope.row.deliveryGuyId }}</template>
        </el-table-column>
        <el-table-column label="配送员名称" align="center">
          <template slot-scope="scope">{{ scope.row.deliveryName }}</template>
        </el-table-column>
        <el-table-column label="状态" align="center">
          <template slot-scope="scope">{{ scope.row.statusMsg }}</template>
        </el-table-column>
...
<script>
import {getDeliveryGuyStatusLogs } from "@/api/log";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getDeliveryGuyStatusLogs(this.listQuery).then((response) => {
